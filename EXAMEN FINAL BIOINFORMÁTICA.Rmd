---
title: "Bioinformática- GBI6-Examen Final"
...
**INTERPRETACIÓN: En la regresión lineal se observa que el ancho y largo del pico de la especie Adelie en la isla 3 (Torgersen) es menor que el resto de las especies, sin embargo existe una similitud del largo y ancho del picho de la especie Chinstrap que se encuentra en la isla 2 (Dream) con la especie Gentoo que se encuentra en la isla 1 (Biscoe) con un valor de 0.43.**
...
**INTERPRETACIÓN: En la imagen se puede observar que existe una mayor intensidad de color a mayor distancia dadas en el gen x10con el suero HIHS a un tiempo de 48, mientras que la intensidad de color es menor en los genes x18 y x4 asi mismo con el uso del HIHS a un tiempo de 48.**
